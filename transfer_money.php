...
<head>
    ...
    <link rel="stylesheet" href="css_and_images/transfer_money.css">
</head>
...
<body>
    <div class="container">
        ...
        <select name="to" class="form-control" required>
            <option value="" disabled selected>Choose person to transfer money</option>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
                $sql = "SELECT * FROM users where id!=$sid";
        ...
        <a href="view_users.php"><button class="btn">Cancel Transaction</button></a>
